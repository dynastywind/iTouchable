...
public class GetStudentListAction extends BaseAction{
	...
	public String execute() throws Exception {
		...
		Page pageBean = stuDao.getStudentList(0, page);
		
		@SuppressWarnings("unchecked")
		Iterator<Student> iter = pageBean.getList().iterator();
		...
		while(iter.hasNext()){
			...
			html = html + "<tr>" +
    					...
    					"<td width='70'>" + student.getId_number() + "</td>" +
    					"<td width='120'>" + 0 + "</td>" +
    					"<td width='120'>" + 0 + "</td>" +
    					"<td width='70'>" + 0 + "</td>" +
    					"<td width='140'>" + 0 + "</td>" +
    					"<td width='70'>" + 0 + "</td>" +
    					"<td width='100'>" + 0 + "</td>" +
    					"<td width='130'>" + DateUtils.format(student.getDate(), DateUtils.FORMAT_LONG) + "</td>" +
