...
public class GetCommentAction extends BaseAction{
	...
	public String execute() throws Exception {
		...
		while(iter.hasNext()){
			...
			returnCommentList = returnCommentList + "<div class='movement_comment_list_div'><a href='#'><img src='" + basePath + "user/userfile/10102212/img/10102212.jpg' width='30' height='30' border='0' class='comment_pic' /></a>"+
				...
				"<div class='comment-text-box'>" + nameHtml + comment.getComment_text() + "<span class='comment_time_span'>"+DateUtils.format(comment.getCreatedate(),DateUtils.FORMAT_MIDDLE)+"</span> <a href='javascript:;'" +
						" class='movement-comment-back' activity_id='"+activity_id+"' at_id='"+comment.getUser_own_id()+"' at_name = '"+comment.getUser_own_name()+"'>[回应]</a>"+
					"</div></div></div>";
		}
